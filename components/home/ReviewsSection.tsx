...
const SEED_REVIEWS: Review[] = [
  {
    ...
    rating: 5,
    message:
      "AKA AI Studio built our official group website mohitmobile.in. Ayush, Komal, and Anushka delivered a top-class, fast portal on time. Our customers can now easily explore our smartphone showrooms and reach us directly on WhatsApp.",
